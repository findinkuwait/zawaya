        ...
        <section className="py-24 bg-background">
            <div className="container mx-auto px-6 md:px-12">
                    ...
                    <div className="flex flex-wrap gap-4">
                        {filters.map(f => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-full font-en-body font-ar-body text-sm tracking-wide transition-all ${filter === f.key ? 'bg-accent text-[#0f0f0f] font-semibold' : 'border border-gray-800 text-gray-400 hover:border-accent hover:text-white'}`}
                            >
                                {f.label}
                            </button>
                        ))}
                ...
                <div className="mt-20 text-center">
                    <Link
                        href="/projects"
                        className="inline-block px-10 py-4 border border-accent text-accent rounded-full hover:bg-accent hover:text-[#0f0f0f] transition-all font-semibold tracking-wide"
                    >
                        {t('btnAll')}
                    </Link>
                </div>

                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8 px-4 md:px-0">
                    {features.map((feature, idx) => (
                        <motion.div
                            ...
                            className="bg-white/5 border border-white/10 p-10 md:p-8 rounded-2xl hover:bg-white/10 transition-colors shadow-none md:shadow-xl hover:shadow-2xl shadow-black/50"
                        >
                            <feature.icon size={48} className="text-accent mb-8 md:mb-6 w-12 h-12 md:w-10 md:h-10" />
                            <h3 className="text-xl font-bold font-en-heading font-ar-heading mb-3">{feature.title}</h3>
                            <p className="text-gray-400 font-en-body font-ar-body leading-relaxed">{feature.desc}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
